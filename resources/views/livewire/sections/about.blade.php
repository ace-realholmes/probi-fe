        ...
        <div class="w-[92%] xl:w-[46%]">
            ...
            <div class="flex flex-col gap-6 md:flex-row">
               <div>
                    ...
                    <p class="text-xl text-gray-600">years of<br> experience</p>
               </div>
               <div>
                    <p class="text-5xl font-bold">+{{ $projects }}</p>
                    <p class="text-xl text-gray-600">project done</p>
               </div>
               <div>
            ...
            <div class="mt-8">
                <button class="p-2 px-6 text-white duration-300 bg-gray-900 rounded-lg hover:bg-white hover:text-black ">Contact Us</button>
            </div>
        </div>
    </div>
    ...
    <div class="w-[92%] mx-auto pt-5 md:flex md:flex-col xl:flex-row xl:items-center">
        <div class="md:w-[92%] xl:w-[46%] ">
            ...
            <div class="gap-6 md:grid-cols-2 md:grid xl:grid-cols-2">
               ...
               <div>
                    <ion-icon class="mb-2 text-4xl" name="camera-outline"></ion-icon>
                    <p class="mb-2 text-base">Capturing life's beauty through my lens. Specializing in wedding, portrait</p>
               </div>
               <div>
                    <ion-icon class="mb-2 text-4xl" name="hourglass-outline"></ion-icon>
                    <p class="mb-2 text-base">Capturing life's beauty through my lens. Specializing in wedding, portrait</p>
               </div>
               <div>
                    <ion-icon class="mb-2 text-4xl" name="card-outline"></ion-icon>
                    <p class="mb-2 text-base">Capturing life's beauty through my lens. Specializing in wedding, portrait</p>
               </div>
            </div>
        </div>
        ...
        <div class="my-6 md:w-[96%] xl:w-[46%] xl:ml-20 flex justify-center">
            <img class="object-cover w-full mx-auto rounded-lg" src="https://images.unsplash.com/photo-1539614474468-f423a2d2270c?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="">
        </div>
    </div>

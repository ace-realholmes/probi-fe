<div>
    <div>
        <div class="w-[92%] mx-auto pt-5 mb-8 xl:flex xl:justify-between">
            <div class="md:w-[92%] xl:w-[38%]">
            ...
            <div class="grid md:p-8 md:gap-8">
                <!-- Wedding service -->
                ...
                <div class="flex gap-8">
                    <div>
                        <img class="w-[100px] mb-4 h-[80px]" src="https://erramix-themes.com/grapholio-demo/images/services/3.png" alt="">
                    </div>
                    <div>
                ...
                <div class="flex gap-8">
                    <div>
                        <img class="w-[100px] mb-4 h-[80px]" src="https://erramix-themes.com/grapholio-demo/images/services/4.png" alt="">
                    </div>
                    <div>
